...
1. Write a function that prepare a dataset from a directory of pdf books for MLM training of an open-soource encoder model like newBert (or a smaller model given my hardware). The dataset should be suitable for use with the HF transformers library trainer class
...
4. Provide functions to save and the newly trained model
